...
public class BusinessOperations {
	...
	protected static void listFiles() {
		...
		System.out.println("List the Current files in  ascending order :) ");
	...
	protected static void deleteFile(String fileToBeDeleted) {
		...
		if(file.exists()) {
			if ( file.delete() ) {
				System.out.println("cheers! File deleted successfully!");
			}
		} else {
			System.out.println("Sorry, Your file wasn't deleted (File Not Found)");
		}
	}
	...
	protected static void searchFile(String fileToBeSearched) {
		...
		if(file.exists()) {
			System.out.println("Yowza! File found!");
		} else {
			System.out.println("Ohh, Your file is not there (File Not Found)");
		}	PrintWriter pw;  
        try {  
